...
export class ItemService {
  ...
  async findAll(options: { page: number, limit: number, search?: string, categoryId?: string, categorySlug?: string }) {
    ...
    const { page, limit, search, categoryId, categorySlug } = options;
