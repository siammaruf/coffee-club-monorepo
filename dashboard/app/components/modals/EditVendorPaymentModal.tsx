...
import type { VendorPayment, UpdateVendorPaymentInput, VendorPaymentType } from "~/types/vendorPayment";
...
interface EditVendorPaymentModalProps {
  open: boolean;
  payment: VendorPayment | null;
  onClose: () => void;
  onSuccess: () => void;
  onUpdate: (id: string, data: UpdateVendorPaymentInput) => Promise<void>;
}

export default function EditVendorPaymentModal({
  open,
  payment,
  onClose,
  onSuccess,
  onUpdate,
}: EditVendorPaymentModalProps) {
