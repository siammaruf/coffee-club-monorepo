  ...
  'inline-flex items-center justify-center gap-2 rounded-lg font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-dark text-white shadow-md hover:bg-dark-light hover:shadow-lg active:scale-[0.98]',
        outline:
          'border-2 border-primary-500 text-primary-700 bg-transparent hover:bg-primary-50 active:scale-[0.98]',
        ghost:
          'text-coffee hover:bg-primary-100 hover:text-primary-800',
        danger:
