...
export const meta: MetaFunction = () => [
  ...
  { name: 'description', content: 'Sign in to your CoffeeClub account to continue ordering.' },
  { property: 'og:title', content: 'Login | CoffeeClub' },
  { property: 'og:description', content: 'Sign in to your CoffeeClub account to continue ordering.' },
