  ...
  return (
    ...
    <div className="bg-cream">
      ...
      <div className="relative bg-gradient-to-br from-primary-950 via-primary-900 to-dark py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/70">
            The story behind Dhaka&apos;s favorite coffee destination.
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-coffee">Our Mission</h2>
              </div>
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-coffee">Our Vision</h2>
              </div>
              <p className="mt-4 text-coffee-light leading-relaxed">
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-coffee">Our Values</h2>
          <div className="mx-auto mt-3 h-1 w-16 rounded-full bg-gradient-to-r from-primary-400 to-primary-600" />
        </div>
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {values.map((value) => (
            <div
              key={value.title}
              className="rounded-2xl border border-primary-100 bg-white p-6 text-center shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
            >
              ...
              <h3 className="mt-4 text-base font-bold text-coffee">{value.title}</h3>
      ...
      <div className="bg-white py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-coffee">Meet Our Team</h2>
            <div className="mx-auto mt-3 h-1 w-16 rounded-full bg-gradient-to-r from-primary-400 to-primary-600" />
          ...
          <div className="mt-12 grid grid-cols-2 gap-6 sm:gap-8 lg:grid-cols-4">
            {team.map((member) => (
              <div key={member.name} className="text-center">
                ...
                <h3 className="mt-4 text-base font-bold text-coffee">{member.name}</h3>
