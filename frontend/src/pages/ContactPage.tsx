      ...
      <div className="bg-warm-bg">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            {/* Contact Info */}
            <div>
              <h2 className="font-heading text-2xl font-bold text-text-primary">Get in Touch</h2>
              ...
              <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
                {contactInfo.map((info) => (
                  ...
                  >
                    ...
                    <h3 className="mt-3 text-sm font-bold text-text-primary">{info.title}</h3>
                    {info.lines.map((line) => (
                      <p key={line} className="mt-0.5 text-sm text-text-body">
                        {line}
                      </p>
                    ))}
                  </div>
              ...
              {/* Map Placeholder */}
              <div className="mt-8 overflow-hidden rounded-2xl border border-border bg-warm-surface shadow-sm">
                <div className="flex h-56 items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-text-muted">Dhaka 1212, Bangladesh</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="rounded-2xl border border-border bg-white p-6 shadow-sm sm:p-8">
                <h2 className="font-heading text-xl font-bold text-text-primary">Send us a Message</h2>
